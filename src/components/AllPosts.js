            ...
            <div style={{marginTop: "50px"}} className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
              {allPostsData &&
                allPostsData.map((post, index) => (
                  ...
                  <span
                    className="block relative rounded shadow leading-snug bg-black border-l-8 " style={{ borderColor: "#07204a", height: "192px" }}
                    key={index}
                  >
                    <img
                    ...
                    <span className="block relative h-full flex justify-start items-start pr-4 pb-4">
                      ...
                      <h2 className="text-gray-800 text-lg font-bold px-3 py-3 text-red-100 flag" style={{ backgroundColor: "rgba(0,0,0,0.8)" }}>
                        {post.title}
                      </h2>
